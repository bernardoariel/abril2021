...
class ModeloProductos{
   ...
   /*=============================================
	...
	static public function mdlMostrarStockCero($tabla){
		echo "UPDATE $tabla SET stock = 0, precio= 0,finOferta='0000-00-00 00:00:00', precioOferta=0, descuentoOferta=0 ,vista = 'productos',oferta=0";
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET stock = 0, precio= 0,finOferta='0000-00-00 00:00:00', precioOferta=0, descuentoOferta=0 ,vista = 'productos',oferta=0");
