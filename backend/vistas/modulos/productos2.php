        ...
        <table class="table table-bordered table-striped dt-responsive tablaProductos" width="100%" style="font-size: 12px">
          ...
          <thead>
            ...
            <tr>
               ...
               <th style="width:50px">F-Promo</th>
               <th>Codigo</th>
          ...
          <?php 
            ...
            if($value["oferta"] != 0){
              ...
              <tr>
                ...
                <td>
                  <button class="btn btnImagenPortada" imgPortada="<?php echo  $value["portada"];?>" data-toggle='modal' data-target='#modalMostrarFotoPortada'>
                  <img src="<?php echo  $value["portada"];?>" width="50px">
                  </button></td>
                <td>
                <?php
                  ...
                  if(file_exists($imagenCatalogo)){
                    echo "<button class='btn btnImagenPortada' imgPortada='../backend/".$value["imagen_tabla"]."' data-toggle='modal' data-target='#modalMostrarFotoPortada'>";
                    echo '<img src="../backend/'.$value["imagen_tabla"].'" width="50px"></button>';

                  }else{

                    echo '<img src="../backend/vistas/img/listado/default.jpg" width="50px">';
...
<div id="modalMostrarFotoPortada" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          ...
          <figure style="heigth:500px; width:500px">
            <img src="" alt="" id="imagenVerPortada">
          </figure>
