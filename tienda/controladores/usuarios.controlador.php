			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$to = $_POST["regEmail"];
					$subject = "Pagina Web";
					// $contenido = "Nombre: ".$_POST["regEmail"]."\n";
					// $contenido .= "Email: ".$_POST["regEmail"]."\n\n";
...
<body>
<img src="https://www.abrilamoblamientos.com.ar/backend/vistas/img/plantilla/logo.png">
<h4>Para comenzar a usar su cuenta de Abril Amoblamientos, debe confirmar su dirección de correo electrónico
<a href="https://www.abrilamoblamientos.com.ar/tienda/verificar/'.$encriptarEmail.'" target="_blank" style="text-decoration:none">Verificar </a></h4>
</body>
</html>';
						
						$contenido2= '<center>
							
							<img style="padding:20px; width:10%" src="http://www.abrilamoblamientos.com.ar/tienda/vistas/imglogo.png">
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
							...
							<img style="padding:20px; width:15%" src="http://www.abrilamoblamientos.com.ar/tienda/icon-email.png">
