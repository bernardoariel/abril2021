...
<head>
	...
	<?php
		...
		if($cabeceras){
			...
			$titulo = $cabeceras['titulo'];

		}else{

			$titulo ="ABRIL AMOBLAMIENTOS";
		}
...
?>
    ...
    <link href="../recursos/plugins/boxicons/css/boxicons.min.css" rel="stylesheet">
...
$item = "nombre";
$valor = "tienda";
$tienda = ControladorPlantilla::ctrMostrarSitio($item,$valor);  
$tienda=$tienda["valor"];
if($tienda=="online"){
...
if(isset($_GET["ruta"])){
	...
	if(empty($rutaProductos)){

		$rutaProductos = ControladorProductos::ctrMostrarInfoListado($item, $valor);
	...
	}else if($rutas[0] == "buscador" || $rutas[0] == "verificar" || $rutas[0] == "salir" || $rutas[0] == "perfil" || $rutas[0] == "carrito-de-compras" || $rutas[0] == "error" || $rutas[0] == "pago" || $rutas[0] == "finalizar-compra" || $rutas[0] == "curso" || $rutas[0] == "ofertas"){
...
<script src="<?php echo $url; ?>vistas/js/finalizar-compra.js"></script>
