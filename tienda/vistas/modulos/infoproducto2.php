				...
				if($infoproducto["tipo"] == "fisico"){
					...
					echo '<div class="col-md-5 col-sm-6 col-xs-12 visorImg">
							...
							if($multimedia != null){
								...
								for($i = 0; $i < count($multimedia); $i ++){
									...
									echo '<img id="lupa1" class="img-thumbnail" src="'.$servidor.$infoproducto["portada"].'">';
								...
								<div class="flexslider">
								  ...
								  <ul class="slides">';
									...
									echo '<li>
								     	<img value="1" class="img-thumbnail" src="'.$servidor.$infoproducto["portada"].'" alt="'.$infoproducto["titulo"].'">
								    </li>';
					...
					echo '<div class="col-md-5 col-sm-6 col-xs-12 visorImg">
							...
							<figure class="visor">
								...
								<img id="lupa1" class="img-thumbnail" src="'.$servidor.$infoproducto["portada"].'">
							...
							<div class="flexslider">
								...
								<ul class="slides">
									...
									<li>
								     	<img value="lupa1" class="img-thumbnail" src="'.$servidor.$infoproducto["portada"].'" alt="'.$infoproducto["titulo"].'">
								    </li></ul>
