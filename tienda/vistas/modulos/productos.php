						...
						if($ofertas["oferta"] == 1){
							...
							<div class="textoBanner textoDer">
								...
								if($ofertas["precioOferta"] != 0){
									...
									echo '<h2 style="color:#fff"><strong>Todos los productos a $ '.ceil($ofertas["precioOferta"]).'</strong></h2>';
						...
						if($ofertas[0]["oferta"] == 1){
							...
							<div class="textoBanner textoDer">
								...
								if($ofertas[0]["precioOferta"] != 0){
									...
									echo '<h2 style="color:#fff"><strong>Todos los productos a $ '.ceil($ofertas[0]["precioOferta"]).'</strong></h2>';
...
<!-- <div class="container-fluid barraProductos" style="background:#fff;">
	...
	<div class="container">
		...
		<div class="row">
			...
			<ul class="breadcrumb fondoBreadcrumb text-uppercase">
				...
				<li><a href="<?php echo $url;  ?>" style="color:#21AD90">INICIO</a></li>
				<li class="active pagActiva" style="color:#FA485A"><?php echo $rutas[0] ?></li>
			...
			$tabla="productos";
			$productos = ControladorProductos::ctrMostrarProductos($ordenar, $item2, $valor2, $base, $tope, $modo,$tabla);
			$listaProductos = ControladorProductos::ctrListarProductos($ordenar, $item2, $valor2,$tabla);
				...
				echo '<ul class="grid0">';
					...
					if($value["estado"] != 0 && $value["precio"] > 0 && $value["stock"] > 2){
						...
						echo '<li class="col-md-3 col-sm-6 col-xs-12">
							...
							<figure <figure style="border-width: 1px;border-style: solid;border-color: #D8D8D8;">
				...
				if(count($listaProductos) != 0){
					...
					if($pagProductos > 4){
						...
						=============================================*/
								...
								echo '<ul class="pagination">
								   <li><a href="'.$url.$rutas[0].'/'.($numPagActual-1).'" class="paginacionColor"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
								...
								for($i = $numPagActual; $i <= ($numPagActual+3); $i ++){
									...
									echo '<li id="item'.$i.'" class="paginacionColor"><a href="'.$url.$rutas[0].'/'.$i.'">'.$i.'</a></li>';
