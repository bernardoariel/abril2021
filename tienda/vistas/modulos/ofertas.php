							...
							<div class="ofertas">
								...
								<figure>
									...
									if($value["descuentoOferta"] != 0){
										...
										echo '<h1 class="text-center text-uppercase  productosOff">%'.$value["descuentoOferta"].' OFF</h1>';
									
									}else{

										echo '<h1 class="text-center text-uppercase productosOff">$ '.$value["precioOferta"].'</h1>';
