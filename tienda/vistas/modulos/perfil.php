				...
				<?php
					...
					if(!$compras){
						...
						foreach ($compras as $key => $value1) {
							...
							$direccion = explode("-",$value1["direccion"]);
									    ...
									    <div class="panel-body">
											...
											$comentarios = ControladorUsuarios::ctrMostrarComentariosPerfil($datos);
												...
												echo '<div class="pull-right">
													...
													<a class="calificarProducto" href="#modalDatos2" data-toggle="modal" >
													
														<button class="btn btnCarritoCss btnEditarEnvio" idCompraEnvio="'.$value1["id"].'">Datos de Envio</button>

													</a>
		
													<a class="calificarProducto" href="#modalComentarios" data-toggle="modal" idComentario="'.$comentarios["id"].'">
													
														<button class="btn  btnCarritoCss">Calificar Producto</button>
												...
												<div class="pull-right">
													...
													<ul>
														...
														<li><small><span style="color:#598FC8;">Telefono: </span><span style="color:#FC216D;">'.$value1["telefono"].'</span></small></li>
														<li><small><span style="color:#598FC8;">Direccion: </span><span style="color:#FC216D;">'.$direccion.'</span></small></li>
														<li><small><span style="color:#598FC8;">Localidad: </span><span style="color:#FC216D;">'.$localidad.'</span></small></li>
													<ul>
			...
			======================================-->
		  	...
		  	<div id="perfil" class="tab-pane fade">
				...
				<div class="row">
					...
					<button class="btn btnEliminarPerfil btn-md pull-right" id="eliminarUsuario">Eliminar cuenta</button>
...
<div class="modal fade modalFormulario" id="modalDatos2" role="dialog">
    ...
    <div class="modal-content modal-dialog">
      ...
      <form method="post">
      	...
      	<input type="hidden" id="idCompraEnvio" name="idCompraEnvio" value="">
        ...
        <input type="submit" class="btn btnCarritoCss btn-block" value="ENVIAR">

        <?php

			$modificarEnvio = new ControladorCarrito();
			$modificarEnvio -> ctrModificarDatosDeEnvio();
