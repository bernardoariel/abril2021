...
=============================================*/
$("#carrito a").attr("href",localStorage.getItem("rutaActual")+"carrito-de-compras/");//asigno
var rutaCarrito = $("#carrito a").attr("href");
...
if(localStorage.getItem("cantidadCesta") != null){
	...
	importeTotal = localStorage.getItem("sumaCesta"); 

	if(importeTotal.indexOf(".")){

		splitImporteTotal = importeTotal.split('.');
		$("#carrito a").attr("href", rutaCarrito+splitImporteTotal[0]+"/"+splitImporteTotal[1]);

	}else{

		$("#carrito a").attr("href", rutaCarrito+importeTotal);
	}
	...
	$(".sumaCesta").html("0");
	$("#carrito a").attr("href", rutaCarrito);
}
...
function sumaSubtotales(){
	...
	importeTotal = localStorage.getItem("sumaCesta"); 
	console.log("fgdgg",importeTotal);
	if(importeTotal.indexOf(".")){
		splitImporteTotal = importeTotal.split('.');
		$("#carrito a").attr("href", rutaCarrito+splitImporteTotal[0]+"/"+splitImporteTotal[1]);
...
$("#btnCheckout").click(function(){
	...
	suma=localStorage.getItem("sumaCesta");
	console.log("suma", suma);

	crearCookie("sumadeCesta", suma, 1);
 ...
 $("#mercadoPago script").attr('data-transaction-amount',mitotal);
// $(script"#mercadoPago #miescript").attr("data-transaction-amount",mitotal);
// $("#mercadoPago").html('<script '+
// 					   ' src="https://www.mercadopago.com.ar/integrations/v1/web-tokenize-checkout.js"'+
// 					   'data-public-key="TEST-1e027ab0-0acf-4b48-922e-1ebf5bef9948"'+
