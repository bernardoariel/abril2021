...
class ModeloProductos{
	...
	static public function mdlMostrarProductosPortada($tabla, $ordenar, $item, $valor, $base, $tope, $modo){
		

		if($item != null){

			$stmt = Conexion::conectar()->prepare("SELECT *FROM $tabla WHERE $item = $valor ORDER BY $ordenar $modo LIMIT $base, $tope");
	...
	static public function mdlMostrarProductosCatalogo($tabla, $ordenar, $item, $valor, $base, $tope, $modo){

		if($item != null){

			$stmt = Conexion::conectar()->prepare("SELECT *FROM $tabla WHERE $item = :$item and vista='catalogo' ORDER BY $ordenar $modo LIMIT $base, $tope");
			...
			$stmt = Conexion::conectar()->prepare("SELECT *FROM $tabla WHERE vista='catalogo' ORDER BY $ordenar $modo LIMIT $base, $tope");
	...
	static public function mdlMostrarProductosCatalogoGrupos($tabla, $base, $tope){


		$stmt = Conexion::conectar()->prepare("SELECT *FROM $tabla WHERE tipo='grupo' ORDER BY RAND() LIMIT $base, $tope");
	...
	static public function mdlBuscarProductos($tabla, $busqueda, $ordenar, $modo, $base, $tope){
		// echo "SELECT * FROM $tabla WHERE ruta like '%$busqueda%' OR titulo like '%$busqueda%' OR titular like '%$busqueda%' OR descripcion like '%$busqueda%' ORDER BY $ordenar $modo";
		$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE ruta like '%$busqueda%' OR titulo like '%$busqueda%' OR titular like '%$busqueda%' OR descripcion like '%$busqueda%' ORDER BY $ordenar $modo" );
	...
	static public function mdlMostrarCategoriasMenu($tabla, $item, $valor){
